...
SECRET_KEY = 'django-insecure-%b@env2brue)w)xrksq$l%n3lb21rd3_w)s1g&xg&%t-hs14u2'
...
EMAIL_USE_TLS = True
EMAIL_USE_SSL = False
EMAIL_HOST_USER = 'akshino.23pmc103@mariancollege.org'
EMAIL_HOST_PASSWORD = 'ltroujdsqoxvfmay'
...
JAZZMIN_SETTINGS = {
    ...
    "site_header": "fitness Hut",
    
    # Logo to use for your site, must be present in static files, used for brand on top left
    "site_logo": "fitfusion.png",
    ...
    "topmenu_links": [
        ...
        {"name": "Customers", "url": "http://127.0.0.1:8000/admin/fitness_app/customer/", "new_window": False},

        # external url that opens in a new window (Permissions can be added)
        {"name": "Products", "url": "http://127.0.0.1:8000/admin/fitness_app/product/", "new_window": False},
...
# },
    ...
    "site_brand": "fitness Hut",
    "welcome_sign": "Welcome to the AdminDashboard",
    "copyright": "fitness Hut",
     "icons": {
